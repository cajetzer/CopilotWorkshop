...
**Time**: ~90 minutes  
**Personas**: David (Architect), Marcus (DevOps), Priya (Junior Developer)
...
### Exercise 1.2: Create Team Standards — "Marcus Builds the Playbook"

#### 📖 The Story

**Marcus** (DevOps Developer, 5 years) has a confession: He's always relied on infrastructure patterns, but application code has felt like guesswork. When he asks Copilot for help, he gets suggestions, but he's never sure if they're the "right" way to do things.

Sarah points to the FanHub codebase: *"See how the backend routes use three different async patterns? That's because the contractor had no standards. Let's fix that—and teach Copilot at the same time."*

Marcus realizes this is his chance to level up. By defining the standards, he'll learn them himself.

**Supporting Cast**: Sarah (Senior Dev) mentors Marcus through this exercise, reviewing his choices.
...
*"I always felt like I was guessing at application code patterns. Now I've defined them myself—and Copilot teaches them to me every time it makes a suggestion. I'm learning the right way by using the right way."*
...
- Marcus's instructions → Copilot follows team patterns
